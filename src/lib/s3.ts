...
export async function getMDXFile(s3Key: string): Promise<string> {
  try {
    // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] console.log("S3 - Fetching MDX file:", { s3Key, bucket: BUCKET_NAME });
    const command = new GetObjectCommand({
      Bucket: BUCKET_NAME,
      Key: s3Key,
    });
    ...
    // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] console.log("S3 - Successfully fetched MDX file content");
    return content;
  } catch (error) {
...
export async function uploadMDXFile(
  ...
  try {
    // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] console.log("S3 - Uploading MDX file:", { filename });
    const timestamp = Date.now();
    ...
    await s3Client.send(command);
    // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] console.log("S3 - Successfully uploaded MDX file:", { key });
    return key;
  } catch (error) {
