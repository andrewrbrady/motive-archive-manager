...
#motivearchive #ferrari #f40 #f40LM #automotivehistory #racecar #collectorcar #vintagecar #vintageracecar`,
    ...
    {
      title: "Classic Car",
      caption: `1967 Ferrari 275 GTB/4 ⚡️ | PININFARINA PERFECTION
...
#mclaren #mclarenp1 #mousemotors #mclarenchicago #hypercar #p1 #collectorcar `,
    },
    {
      ...
      caption: `2024 Rolls-Royce Ghost ✨ | RANGE BROTHER
...
export const CAPTION_GUIDELINES = {
  instagram: [
    ...
    "Structure: Intro → Specs → Key Features → Hashtags",
  ...
  youtube: [
    ...
    "Structure: Title → Hook → Specs → CTA → Tags",
