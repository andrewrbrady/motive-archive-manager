      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-card rounded-lg shadow-lg border">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">
            Get started with your company Google account
          </p>
        </div>
        ...
        <div className="space-y-4">
          <Button
            ...
            disabled={isLoading}
            className="w-full h-12 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 font-medium rounded-lg transition-colors flex items-center justify-center gap-3"
          >
            {isLoading ? (
              <>
        ...
        <div className="mt-6 text-center space-y-4">
          <p className="text-sm text-muted-foreground">
            Your Google account will be automatically set up for you.
          </p>
          <p className="text-sm text-muted-foreground">
