    ...
    try {
      ...
      const promises = assetIds.map((id) =>
        fetch(`/api/raw/${id}`).then(async (res) => {
          ...
          // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] console.log(`Asset data for ${id}:`, data);
      ...
      // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] console.log("All transformed assets:", validAssets);
