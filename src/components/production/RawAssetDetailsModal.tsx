...
export default function RawAssetDetailsModal({
  ...
  const handleDriveClick = (driveId: string, e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] console.log("Navigating to hard drive:", driveId);
    ...
    setTimeout(() => {
      // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] console.log("Updating Next.js router for hard drive:", driveId);
      updateParams(
        {
          tab: "hard-drives",
          drive: driveId,
      ...
      // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] console.log("Next.js router update completed for hard drive");
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <button
              onClick={() => {
                // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] // [REMOVED] console.log("Editing asset:", asset._id);
