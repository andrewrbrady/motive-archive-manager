...
interface MotiveLogoProps {
  className?: string;
  variant?: "default" | "animated";
  onAnimationEnd?: () => void;
}

export function MotiveLogo({
  className,
  variant = "default",
  onAnimationEnd,
}: MotiveLogoProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M111.79,138.24l-18.18,102.95h-3.26s19.5-111.81,19.5-111.81l42.96,67.03,43.76-68.06,18.11,98-2.33,5.09-17.5-93.96-41.91,65.06-41.14-64.29ZM152.94,191.62l44.77-69.65,18.72,100.54,3.01-6.57-19.43-104.86-47.08,72.77-46.86-72.49-22.41,129.83h4.02s20.86-118.83,20.86-118.83l44.4,69.26ZM152.93,179.95l48.41-75.2,19.76,107.55,3.83-8.37-20.72-113-51.28,79.27-50.52-78.46-26.4,149.45h5.36s23.92-135.67,23.92-135.67l47.65,74.44ZM190.92,241.2h1.9s-9.05-48.28-9.05-48.28l-30.83,48.47-29.82-45.89-8.09,45.72,1.62-.02,7.44-41.22,28.94,44.17,30.13-46.93,7.75,43.98ZM152.92,212.67l39.22-61,16.51,87.85,1.67-3.64-16.99-91.47-40.51,62.9-39.5-61.74-17.01,95.61,2.72-.03,15.63-87.82,38.27,59.33ZM152.74,233.34l33.3-51.47,10.72,59.32h2.1s-11.86-64.64-11.86-64.64l-34.22,53.4-33.02-51.34-10.54,62.6,1.81-.02,9.76-57.03,31.95,49.18ZM152.92,223.02l36.18-56.08,13.78,74.25h2.29s-14.92-81.14-14.92-81.14l-37.31,58.36-36.4-57.09-14.2,79.81,2.81.06,12.84-72.26,34.94,54.09Z" />
      </g>
    </svg>
  );
}
