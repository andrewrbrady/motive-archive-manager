  ...
  useEffect(() => {
    if (model) {
      setFormData({
        ...
        model: model.model || "",
        generation: {
          code: model.generation?.code || "",
          year_range: model.generation?.year_range || {
            start: new Date().getFullYear(),
            end: undefined,
          },
          body_styles: model.generation?.body_styles || [],
          trims: model.generation?.trims || [],
        },
        ...
        <ScrollArea className="max-h-[calc(90vh-120px)]">
          <form onSubmit={handleSubmit} className="space-y-6 p-1">
            <Alert>
              ...
              <AlertDescription>
                This form edits basic model information. For detailed engine and
                trim modifications, use batch import.
              </AlertDescription>
            </Alert>
